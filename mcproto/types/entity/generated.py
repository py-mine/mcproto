...
class ItemDisplayEM(DisplayEM):
    ...
    :type item: :class:`Slot`, optional, default: :attr:`Slot(present=False)`
    ...
    item: Slot = entry(SlotEME, Slot(present=False))
...
class ThrownEggEM(ThrownItemProjectileEM):
    ...
    item: Slot = entry(SlotEME, Slot(present=True, item_id=NotImplemented, item_count=1))
...
class FireworkRocketEM(EntityEM):
    ...
    :type firework_info: :class:`Slot`, optional, default: :attr:`Slot(present=False)`
    ...
    firework_info: Slot = entry(SlotEME, Slot(present=False))
