...
class MSAAccount(Account):
    ...
    async def from_xbox_access_token(cls, client: httpx.AsyncClient, access_token: str) -> Self:
        ...
        See [`_get_access_token_from_xbox`][..] for how to obtain the `access_token`. Note that
        in most cases, you'll want to use [`xbox_auth`][..] rather than this method directly.
        """
    ...
    async def xbox_auth(cls, client: httpx.AsyncClient, user_hash: str, xsts_token: str) -> Self:
        ...
        See [`mcproto.auth.microsoft.xbox.xbox_auth`][mcproto.auth.microsoft.xbox.xbox_auth] for how to obtain
        the `user_hash` and `xsts_token`.
        """
