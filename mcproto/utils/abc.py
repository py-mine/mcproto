...
class RequiredParamsABCMixin:
    ...
    This class performs a similar check to what [`ABC`][?abc.] already does with abstractmethods,
    but for class variables. The required class variable names are set with `_REQUIRED_CLASS_VARS`
    ...
    Additionally, you can also define `_REQUIRED_CLASS_VARS_NO_MRO` class var, holding names of
    ...
    optional, and if `_REQUIRED_CLASS_VARS_NO_MRO` isn't set, this check is skipped.
    """
...
class Serializable(ABC):
    ...
    def serialize(self) -> Buffer:
        """Represent the object as a [`Buffer`][mcproto.buffer.] (transmittable sequence of bytes)."""
        buf = Buffer()
    ...
    def serialize_to(self, buf: Buffer, /) -> None:
        """Write the object to a [`Buffer`][mcproto.buffer.]."""
    ...
    def validate(self) -> None:
        ...
        Note:
            This method is called by [`__attrs_post_init__`][mcproto.utils.abc.Serializable.]
        """
        return
    ...
    def deserialize(cls, buf: Buffer, /) -> Self:
        """Construct the object from a [`Buffer`][mcproto.buffer.] (transmittable sequence of bytes)."""
        raise NotImplementedError
